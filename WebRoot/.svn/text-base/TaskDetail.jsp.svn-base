...
<title>ScilabCloud-TaskDetail</title>
<!-- InstanceEndEditable -->
</head>
<!--布局详见style.css-->
...
<!--第二部分开始-->
 <div id="PictureChange">
   <div id=BigText><!-- InstanceBeginEditable name="EditRegion3" --><img src="images/TextTaskDetail.png" width="245" height="60" alt="TextTaskDetail" longdesc="images/TextTaskDetail.png" /><!-- InstanceEndEditable --></div>
...
<table border=1 cellspacing=0 cellpadding=0 width="480">
	  ...
	  <br><br>
	    <div id="myResult">     
			...
			<a href="<s:url value='/CheckTask!getResult'/>?taskname=${taskInfo.taskName}" class="taskResult" title="${taskInfo.taskName}" >View Task Results</a></div></td>
