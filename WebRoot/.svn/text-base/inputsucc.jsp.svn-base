...
<title>ScilabCloud-InputSuccess</title>
<!-- InstanceEndEditable -->
</head>
<!--布局详见style.css-->
...
<!--第二部分开始-->
 <div id="PictureChange">
   <div id=BigText><!-- InstanceBeginEditable name="EditRegion3" --><img src="images/TextFunction.png" width="235" height="60" alt="TextFuntion" longdesc="images/TextFunction.png" /><!-- InstanceEndEditable --></div>
